...
Этот maintenance-форк публикует актуальные сборки AyuGram, пока релизы upstream
приостановлены. Он не добавляет функций или личного брендинга, сохраняет
авторство upstream и предлагает исправления основному проекту. Эти сборки не
являются официальными релизами upstream.

Версия 7.2.5 основана на [PR #460](https://github.com/AyuGram/AyuGramDesktop/pull/460).
Релизные артефакты собираются GitHub Actions из помеченного tag исходного кода,
автоматическое обновление отключено. Подробности описаны в
[руководстве](docs/releasing.md).

Технические сборки для macOS и Windows доступны в
[Releases этого форка](https://github.com/oviron/AyuGramDesktop/releases). Они
не подписаны сертификатом издателя и не нотарифицированы; перед установкой
проверьте `SHA256SUMS.txt`. Команды пакетных менеджеров ниже относятся к upstream
или сторонним сопровождающим.
